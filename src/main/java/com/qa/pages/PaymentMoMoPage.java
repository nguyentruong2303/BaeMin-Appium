...
public class PaymentMoMoPage extends BaseTest {
    ...
    @AndroidFindBy(xpath = "//android.view.ViewGroup[@content-desc=\"payment_momo_button\"]/android.view.ViewGroup")
    private MobileElement btnMoMo;
